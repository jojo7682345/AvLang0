...
#define TOKEN_LIST\
	...
	TOKEN_PUNCTUATOR("++",			INCREMENT,					0x21)\
	TOKEN_PUNCTUATOR("--", 			DECREMENT,					0x22)\
	TOKEN_PUNCTUATOR("+=",			INCREMENT_ASSIGN,			0x23)\
	TOKEN_PUNCTUATOR("-=",			DECREMENT_ASSIGN,			0x24)\
	TOKEN_PUNCTUATOR("%",			MODULUS,					0x25)\
	TOKEN_PUNCTUATOR("~",			LOGICAL_INVERT,				0x26)\
	TOKEN_PUNCTUATOR("..", 			RANGE,						0x27)\
	\
