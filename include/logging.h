...
typedef enum AvResult {
	...
	AV_INVALID_SIZE = AV_ERROR | 15,
	AV_ERROR_INFO = AV_ERROR | 16,
} AvResult;
...
extern const uint32 defaultDisabledLogCategoryCount;

extern const AvResult defaultDisabledMessages[];
extern const uint32 defaultDisabledCategoryCount;
